...
public class TempOut extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temprature_outside);

        getSupportActionBar().setTitle("Temprature Outside House");

        final Bundle data = this.getIntent().getExtras();


        image = (ImageView) findViewById(R.id.tempOutImage);
        ...
        tempText = (TextView) findViewById(R.id.tempOutTitle);
