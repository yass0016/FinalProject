...
public class ProjectDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_ROOM_LAST_VISITED = "lastVisited";
    ...
    private static final String CREATE_ROOM_ITEMS_TABLE = "create table "
            ...
            + COLUMN_ROOM_DEVICE_TYPE + " int not null default 0, "
            + COLUMN_ROOM_DEVICE_TITLE + " text not null, "
            + COLUMN_ROOM_DEVICE_IMAGE + " text not null, "
            + COLUMN_ROOM_LAST_VISITED + " INTEGER, "
            + COLUMN_ROOM_CREATED + " INTEGER);";
